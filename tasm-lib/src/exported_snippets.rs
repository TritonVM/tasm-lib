...
pub fn name_to_snippet(fn_name: &str) -> Box<dyn BasicSnippet> {
    match fn_name {
        ...
        "tasmlib_arithmetic_u32_leadingzeros" => Box::new(u32::leadingzeros::Leadingzeros),
        ...
        "tasmlib_arithmetic_u64_index_of_last_nonzero_bit" => Box::new(u64::index_of_last_nonzero_bit::IndexOfLastNonZeroBit),
