...
pub fn name_to_snippet(fn_name: &str) -> Box<dyn BasicSnippet> {
    match fn_name {
        ...
        "tasm_io_read_secret_u128" => Box::new(ReadSecret(DataType::U128)),
        ...
        "tasm_io_read_stdin_u128" => Box::new(ReadStdIn(DataType::U128)),
        ...
        "tasm_io_write_to_stdout_u128" => Box::new(WriteToStdout(DataType::U128)),
        ...
        // safe lists
        "tasm_list_safeimplu32_get_element_bool" => Box::new(SafeGet(DataType::Bool)),
        "tasm_list_safeimplu32_get_element_u32" => Box::new(SafeGet(DataType::U32)),
        "tasm_list_safeimplu32_get_element_u64" => Box::new(SafeGet(DataType::U64)),
        "tasm_list_safeimplu32_get_element_bfe" => Box::new(SafeGet(DataType::BFE)),
        "tasm_list_safeimplu32_get_element_xfe" => Box::new(SafeGet(DataType::XFE)),
        "tasm_list_safeimplu32_get_element_digest" => Box::new(SafeGet(DataType::Digest)),

        "tasm_list_safeimplu32_pop_bool" => Box::new(SafePop(DataType::Bool)),
        "tasm_list_safeimplu32_pop_u32" => Box::new(SafePop(DataType::U32)),
        "tasm_list_safeimplu32_pop_u64" => Box::new(SafePop(DataType::U64)),
        "tasm_list_safeimplu32_pop_bfe" => Box::new(SafePop(DataType::BFE)),
        "tasm_list_safeimplu32_pop_xfe" => Box::new(SafePop(DataType::XFE)),
        "tasm_list_safeimplu32_pop_digest" => Box::new(SafePop(DataType::Digest)),

        "tasm_list_safeimplu32_push_bool" => Box::new(SafePush(DataType::Bool)),
        "tasm_list_safeimplu32_push_u32" => Box::new(SafePush(DataType::U32)),
        "tasm_list_safeimplu32_push_u64" => Box::new(SafePush(DataType::U64)),
        "tasm_list_safeimplu32_push_bfe" => Box::new(SafePush(DataType::BFE)),
        "tasm_list_safeimplu32_push_xfe" => Box::new(SafePush(DataType::XFE)),
        "tasm_list_safeimplu32_push_digest" => Box::new(SafePush(DataType::Digest)),

        "tasm_list_safeimplu32_set_element_bool" => Box::new(SafeSet(DataType::Bool)),
        "tasm_list_safeimplu32_set_element_u32" => Box::new(SafeSet(DataType::U32)),
        "tasm_list_safeimplu32_set_element_u64" => Box::new(SafeSet(DataType::U64)),
        "tasm_list_safeimplu32_set_element_bfe" => Box::new(SafeSet(DataType::BFE)),
        "tasm_list_safeimplu32_set_element_xfe" => Box::new(SafeSet(DataType::XFE)),
        "tasm_list_safeimplu32_set_element_digest" => Box::new(SafeSet(DataType::Digest)),

        "tasm_list_safeimplu32_new_bool" => Box::new(SafeNew(DataType::Bool)),
        "tasm_list_safeimplu32_new_u32" => Box::new(SafeNew(DataType::U32)),
        "tasm_list_safeimplu32_new_u64" => Box::new(SafeNew(DataType::U64)),
        "tasm_list_safeimplu32_new_bfe" => Box::new(SafeNew(DataType::BFE)),
        "tasm_list_safeimplu32_new_xfe" => Box::new(SafeNew(DataType::XFE)),
        "tasm_list_safeimplu32_new_digest" => Box::new(SafeNew(DataType::Digest)),

        "tasm_list_safeimplu32_length_bool" => Box::new(SafeLength(DataType::Bool)),
        "tasm_list_safeimplu32_length_u32" => Box::new(SafeLength(DataType::U32)),
        "tasm_list_safeimplu32_length_u64" => Box::new(SafeLength(DataType::U64)),
        "tasm_list_safeimplu32_length_bfe" => Box::new(SafeLength(DataType::BFE)),
        "tasm_list_safeimplu32_length_xfe" => Box::new(SafeLength(DataType::XFE)),
        "tasm_list_safeimplu32_length_digest" => Box::new(SafeLength(DataType::Digest)),

        "tasm_list_safeimplu32_set_length_bool" => Box::new(SafeSetLength(DataType::Bool)),
        "tasm_list_safeimplu32_set_length_u32" => Box::new(SafeSetLength(DataType::U32)),
        "tasm_list_safeimplu32_set_length_u64" => Box::new(SafeSetLength(DataType::U64)),
        "tasm_list_safeimplu32_set_length_bfe" => Box::new(SafeSetLength(DataType::BFE)),
        "tasm_list_safeimplu32_set_length_xfe" => Box::new(SafeSetLength(DataType::XFE)),
        "tasm_list_safeimplu32_set_length_digest" => Box::new(SafeSetLength(DataType::Digest)),
        ...
        // unsafe lists
        "tasm_list_unsafeimplu32_get_element_bool" => Box::new(UnsafeGet(DataType::Bool)),
        "tasm_list_unsafeimplu32_get_element_u32" => Box::new(UnsafeGet(DataType::U32)),
        "tasm_list_unsafeimplu32_get_element_u64" => Box::new(UnsafeGet(DataType::U64)),
        "tasm_list_unsafeimplu32_get_element_bfe" => Box::new(UnsafeGet(DataType::BFE)),
        "tasm_list_unsafeimplu32_get_element_xfe" => Box::new(UnsafeGet(DataType::XFE)),
        "tasm_list_unsafeimplu32_get_element_digest" => Box::new(UnsafeGet(DataType::Digest)),

        "tasm_list_unsafeimplu32_pop_bool" => Box::new(UnsafePop(DataType::Bool)),
        "tasm_list_unsafeimplu32_pop_u32" => Box::new(UnsafePop(DataType::U32)),
        "tasm_list_unsafeimplu32_pop_u64" => Box::new(UnsafePop(DataType::U64)),
        "tasm_list_unsafeimplu32_pop_bfe" => Box::new(UnsafePop(DataType::BFE)),
        "tasm_list_unsafeimplu32_pop_xfe" => Box::new(UnsafePop(DataType::XFE)),
        "tasm_list_unsafeimplu32_pop_digest" => Box::new(UnsafePop(DataType::Digest)),

        "tasm_list_unsafeimplu32_push_bool" => Box::new(UnsafePush(DataType::Bool)),
        "tasm_list_unsafeimplu32_push_u32" => Box::new(UnsafePush(DataType::U32)),
        "tasm_list_unsafeimplu32_push_u64" => Box::new(UnsafePush(DataType::U64)),
        "tasm_list_unsafeimplu32_push_bfe" => Box::new(UnsafePush(DataType::BFE)),
        "tasm_list_unsafeimplu32_push_xfe" => Box::new(UnsafePush(DataType::XFE)),
        "tasm_list_unsafeimplu32_push_digest" => Box::new(UnsafePush(DataType::Digest)),

        "tasm_list_unsafeimplu32_set_element_bool" => Box::new(UnsafeSet(DataType::Bool)),
        "tasm_list_unsafeimplu32_set_element_u32" => Box::new(UnsafeSet(DataType::U32)),
        "tasm_list_unsafeimplu32_set_element_u64" => Box::new(UnsafeSet(DataType::U64)),
        "tasm_list_unsafeimplu32_set_element_bfe" => Box::new(UnsafeSet(DataType::BFE)),
        "tasm_list_unsafeimplu32_set_element_xfe" => Box::new(UnsafeSet(DataType::XFE)),
        "tasm_list_unsafeimplu32_set_element_digest" => Box::new(UnsafeSet(DataType::Digest)),

        "tasm_list_unsafeimplu32_new_bool" => Box::new(UnsafeNew(DataType::Bool)),
        "tasm_list_unsafeimplu32_new_u32" => Box::new(UnsafeNew(DataType::U32)),
        "tasm_list_unsafeimplu32_new_u64" => Box::new(UnsafeNew(DataType::U64)),
        "tasm_list_unsafeimplu32_new_bfe" => Box::new(UnsafeNew(DataType::BFE)),
        "tasm_list_unsafeimplu32_new_xfe" => Box::new(UnsafeNew(DataType::XFE)),
        "tasm_list_unsafeimplu32_new_digest" => Box::new(UnsafeNew(DataType::Digest)),

        "tasm_list_unsafeimplu32_length_long_bool" => Box::new(UnsafeLength(DataType::Bool)),
        "tasm_list_unsafeimplu32_length_long_u32" => Box::new(UnsafeLength(DataType::U32)),
        "tasm_list_unsafeimplu32_length_long_u64" => Box::new(UnsafeLength(DataType::U64)),
        "tasm_list_unsafeimplu32_length_long_bfe" => Box::new(UnsafeLength(DataType::BFE)),
        "tasm_list_unsafeimplu32_length_long_xfe" => Box::new(UnsafeLength(DataType::XFE)),
        "tasm_list_unsafeimplu32_length_long_digest" => Box::new(UnsafeLength(DataType::Digest)),

        "tasm_list_unsafeimplu32_set_length_bool" => Box::new(UnsafeSetLength(DataType::Bool)),
        "tasm_list_unsafeimplu32_set_length_u32" => Box::new(UnsafeSetLength(DataType::U32)),
        "tasm_list_unsafeimplu32_set_length_u64" => Box::new(UnsafeSetLength(DataType::U64)),
        "tasm_list_unsafeimplu32_set_length_bfe" => Box::new(UnsafeSetLength(DataType::BFE)),
        "tasm_list_unsafeimplu32_set_length_xfe" => Box::new(UnsafeSetLength(DataType::XFE)),
        "tasm_list_unsafeimplu32_set_length_digest" => Box::new(UnsafeSetLength(DataType::Digest)),
