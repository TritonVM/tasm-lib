...
pub fn name_to_snippet(fn_name: &str) -> Box<dyn BasicSnippet> {
    match fn_name {
        ...
        "tasm_list_unsafeimplu32_length_long___bool" => Box::new(UnsafeLength(DataType::Bool)),
        "tasm_list_unsafeimplu32_length_long___u32" => Box::new(UnsafeLength(DataType::U32)),
        "tasm_list_unsafeimplu32_length_long___u64" => Box::new(UnsafeLength(DataType::U64)),
        "tasm_list_unsafeimplu32_length_long___bfe" => Box::new(UnsafeLength(DataType::BFE)),
        "tasm_list_unsafeimplu32_length_long___xfe" => Box::new(UnsafeLength(DataType::XFE)),
        "tasm_list_unsafeimplu32_length_long___digest" => Box::new(UnsafeLength(DataType::Digest)),
