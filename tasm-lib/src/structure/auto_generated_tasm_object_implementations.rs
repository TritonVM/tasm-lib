use crate::twenty_first::{
    shared_math::{tip5::Tip5, x_field_element::XFieldElement},
    util_types::mmr::{mmr_accumulator::MmrAccumulator, mmr_membership_proof::MmrMembershipProof},
};
use triton_vm::{proof_item::FriResponse, Digest};
...
impl ::tasm_lib::structure::tasm_object::TasmObject for MmrMembershipProof<Tip5> {
    fn get_field(field_name: &str) -> Vec<triton_vm::instruction::LabelledInstruction> {
        match field_name {
            "authentication_path" => {
                let current = {
                    if let Some(size) =  <Vec<Digest>as crate::twenty_first::shared_math::bfield_codec::BFieldCodec> ::static_length(){
            [triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(size as u64)))].to_vec()
          }else {
            [triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::ReadMem(::triton_vm::op_stack::NumberOfWords::N1)),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(1u64))),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Add),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Swap(::triton_vm::op_stack::OpStackElement::ST1)),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(1u64))),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Add),].to_vec()
          }
                };
                let getter = {
                    if<Vec<Digest>as crate::twenty_first::shared_math::bfield_codec::BFieldCodec> ::static_length().is_some(){
            ...
            if let Some(size) =  <u64 as crate::twenty_first::shared_math::bfield_codec::BFieldCodec> ::static_length(){
              [triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(size as u64)))].to_vec()
            }else {
              [triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::ReadMem(::triton_vm::op_stack::NumberOfWords::N1)),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(1u64))),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Add),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Swap(::triton_vm::op_stack::OpStackElement::ST1)),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(1u64))),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Add),].to_vec()
            }
                ...
                let getter = {
                    if <u64 as crate::twenty_first::shared_math::bfield_codec::BFieldCodec>::static_length(
                    )
                    .is_some()
                    {
        ...
        match field_name {
          ...
          [triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::ReadMem(::triton_vm::op_stack::NumberOfWords::N1)),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(1u64))),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Add),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Swap(::triton_vm::op_stack::OpStackElement::ST1)),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(1u64))),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Add),].to_vec()
            ...
            "leaf_index" => {
                ...
                let jumper = {
                    if let Some(size) =
                        <u64 as crate::twenty_first::shared_math::bfield_codec::BFieldCodec>::static_length(
                        )
                    {
                        [triton_vm::instruction::LabelledInstruction::Instruction(
                            triton_vm::instruction::AnInstruction::Push(
    ...
    > {
        let length: usize = if let Some(static_length) =
            <Vec<Digest> as crate::twenty_first::shared_math::bfield_codec::BFieldCodec>::static_length()
        {
            static_length
        } else {
        ...
        let authentication_path: Vec<Digest> =
            *crate::twenty_first::shared_math::bfield_codec::BFieldCodec::decode(&sequence)?;
        let length: usize = if let Some(static_length) =
            <u64 as crate::twenty_first::shared_math::bfield_codec::BFieldCodec>::static_length()
        {
            static_length
...
impl ::tasm_lib::structure::tasm_object::TasmObject
    for MmrAccumulator<crate::twenty_first::shared_math::tip5::Tip5>
{
    fn get_field(field_name: &str) -> Vec<triton_vm::instruction::LabelledInstruction> {
        match field_name {
            "peaks" => {
...
impl ::tasm_lib::structure::tasm_object::TasmObject for FriResponse {
    fn get_field(field_name: &str) -> Vec<triton_vm::instruction::LabelledInstruction> {
        match field_name {
            "revealed_leaves" => {
                let current = {
                    if let Some(size) =  <Vec<XFieldElement>as crate::twenty_first::shared_math::bfield_codec::BFieldCodec> ::static_length(){
              [triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(size as u64)))].to_vec()
            }else {
              [triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::ReadMem(::triton_vm::op_stack::NumberOfWords::N1)),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(1u64))),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Add),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Swap(::triton_vm::op_stack::OpStackElement::ST1)),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(1u64))),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Add),].to_vec()
            }
                ...
                let getter = {
                    if<Vec<XFieldElement>as crate::twenty_first::shared_math::bfield_codec::BFieldCodec> ::static_length().is_some(){
              [triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Pop(::triton_vm::op_stack::NumberOfWords::N1)),].to_vec()
            }else {
              [triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Pop(::triton_vm::op_stack::NumberOfWords::N1)),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Push(crate::twenty_first::shared_math::b_field_element::BFieldElement::new(1u64))),triton_vm::instruction::LabelledInstruction::Instruction(triton_vm::instruction::AnInstruction::Add),].to_vec()
            }
    ...
    fn decode_iter<Itr: Iterator<Item = triton_vm::BFieldElement>>(
        ...
        ::std::boxed::Box<dyn std::error::Error + ::core::marker::Send + ::core::marker::Sync>,
    > {
        let length:usize = if let Some(static_length) =  <Vec<XFieldElement>as crate::twenty_first::shared_math::bfield_codec::BFieldCodec> ::static_length(){
        static_length
      }else {
        iterator.next().unwrap().value()as usize
      };
