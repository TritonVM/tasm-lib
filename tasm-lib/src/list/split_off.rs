...
impl BasicSnippet for SplitOff {
    ...
    fn sign_offs(&self) -> HashMap<Reviewer, SignOffFingerprint> {
        ...
        match self.element_type.stack_size() {
            1 => _ = sign_offs.insert(Reviewer("ferdinand"), 0xa784455c7c2ddd5f.into()),
            2 => _ = sign_offs.insert(Reviewer("ferdinand"), 0xf3a117ed2d25dbca.into()),
            3 => _ = sign_offs.insert(Reviewer("ferdinand"), 0xa064aace17a1fe47.into()),
            4 => _ = sign_offs.insert(Reviewer("ferdinand"), 0x8302fca415f7f95.into()),
            5 => _ = sign_offs.insert(Reviewer("ferdinand"), 0xeb0558520e40d94f.into()),
            _ => (),
        }
